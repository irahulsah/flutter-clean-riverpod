...
abstract class $PostModelCopyWith<$Res> {
  ...
  $Res call({String firstName, String email, bool isActive});
}
...
class _$_PostModel extends _PostModel {
  _$_PostModel(
      {required this.firstName, required this.email, this.isActive = false})
      : super._();
  ...
  @override
  String toString() {
    return 'PostModel(firstName: $firstName, email: $email, isActive: $isActive)';
  }
...
abstract class _PostModel extends PostModel {
  factory _PostModel(
      ...
      final bool isActive}) = _$_PostModel;
